...
/**
 * REST controller for managing {@link dev.flaviojunior.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    /**
     * {@code POST  /categories} : Cria um(a) novo(a) category.
     *
    ...
    public ResponseEntity<Category> partialUpdateCategory(
        ...
        return ResponseUtil.wrapOrNotFound(
                result,
                HeaderUtil.createEntityUpdateAlert(applicationName, ENTITY_NAME, category.getId().toString())
        );
    }
