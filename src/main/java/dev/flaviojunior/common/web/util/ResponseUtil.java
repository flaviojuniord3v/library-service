...
public interface ResponseUtil {
	...
	/**
	 * Wrap the optional into a {@link ResponseEntity} with
	 * an {@link HttpStatus#OK} status, or if it's empty,
	 * it returns a {@link ResponseEntity} with
	...
	/**
	 * Wrap the optional into a {@link ResponseEntity} with
	 * an {@link HttpStatus#OK} status with the headers, or
	 * if it's empty, throws a
	 * {@link ResponseStatusException} with status
	 * {@link HttpStatus#NOT_FOUND}.
	 *
	 * @param <X>           type of the response
	 * @param maybeResponse response to return if present
