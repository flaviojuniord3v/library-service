...
/**
 * REST controller for managing {@link dev.flaviojunior.domain.Author}.
 */
@RestController
@RequestMapping("/api")
public class AuthorResource {
    ...
    /**
     * {@code POST  /authors} : Cria um(a) novo(a) author.
     *
    ...
    public ResponseEntity<Author> partialUpdateAuthor(
        ...
        return ResponseUtil.wrapOrNotFound(
                result,
                HeaderUtil.createEntityUpdateAlert(applicationName, ENTITY_NAME, author.getId().toString())
        );
    }
